...
(function (module) {
    ...
    args.forEach(function (arg) {
        if (arg[0] !== '-') {
            ...
            case 0:
                conf.sites = arg;
                console.log('setting conf.sites = ' +conf.sites);
                return;
            case 1:
                conf.port = arg;
                console.log('setting conf.port = ' +conf.port);
                return;
            case 2:
                conf['secure-port'] = arg;
                console.log('setting conf[secure-port] = ' +conf['secure-port']);
                return;
            case 3:
                conf['secure-key'] = arg;
                console.log('setting conf[secure-key] = ' +conf['secure-key']);
                return;
            case 4:
                conf['secure-cert'] = arg;
                console.log('setting conf[secure-cert] = ' +conf['secure-cert']);
                return;
            default:
