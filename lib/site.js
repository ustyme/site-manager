...
//        var templateKeys = Object.keys(module.templateFiles);
//      var i = templateKeys.length;
//      var propName;
//
//      while(i--) {
//        propName = templateKeys[i];
//        var propValues = module.templateFiles[propName];
//        var countValues = propValues.length;
//        module.templateFiles[propName] = [];
//        while(countValues--) {
//          var file = propValues[countValues];
//          var basename = path.basename(file);
//          templateFiles[basename] = file;
//          module.templateFiles[propName].push(file);
//        }
//      }
//
//      module.templateFiles = [];
    ...
    Site.prototype.start = function (app, cb) {
        ...
        app.use(minify(module, self.logger));
